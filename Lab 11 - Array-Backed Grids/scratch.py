...
class Kid:
    def __init__(self, kHealth, kAttack, kLuck, kRanged, kName):
...
def hitChance(luck):
    ...
    if luck < hit:
        ...
        print("You hit back your parents")
        return True
...
def createClass():
    ...
    return(kHealth, kAttack, kLuck, kRanged, kName)


class_data = createClass()

character = Kid(class_data[0], class_data[1], class_data[2], class_data[3], class_data[4])
...
second = Kid(class_data[0], class_data[1], class_data[2], class_data[3], class_data[4])
pprint(vars(second))
displayintro()
main()